...
There is no potential relationship, because the LotArea doesn't affect the SalePrice. When the SalePrice increases the LotArea stays the same in the 0-10000 range (Also there is no LotSize only a LotArea).
