...
Om ons scrumproces bij te houden maken wij gebruik van waffle.io. Dit is een handig programma, aangezien het direct issues in GitHub aanmaakt en een link hiermee bevat. Ons scrumboard is [hier](https://waffle.io/urbinn/urbinn) terug te vinden. De issues die tot nu toe door mij zijn opgepakt en afgerond zijn beschreven in het bestand [issues](https://github.com/NektariosEvangelou/KB-74-Urbinn-Portfolio/blob/master/GitHub%20Issues/Issues.md). Issue 86 - Ground truth nieuwe trainingsdata labelen, Issue 121, 131 en 135 & Issues 152 t/m 155 en 157 t/m 159 (het schrijven van het paper) waren een van de meest tijdrovende en uitdagende issues die tijdens dit project waren voorgekomen. In mijn ogen de issues waar veel werk door mij aan is verricht en goede resultaten opleverden. 
